...
echo ""
echo "Next steps:"
echo "  1. Test the model on single word:"
echo "     python inference.py --model_path $OUTPUT_DIR --word \"кітап\" --pos_tag \"Зат есім\""
echo ""
echo "  2. Run evaluation on eval_1000.json:"
echo "     python evaluate.py --model_path $OUTPUT_DIR --eval_data eval_1000.json --output results.json"
echo ""
